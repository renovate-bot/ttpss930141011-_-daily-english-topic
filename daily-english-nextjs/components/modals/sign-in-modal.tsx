    ...
    <Dialog open={showSignInModal} onOpenChange={setShowSignInModal}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col items-center justify-center space-y-3 border-b bg-background px-4 py-6 pt-8 text-center sm:px-16">
          {/* Logo */}
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-cyan-600">
            <span className="text-xl font-bold text-white">E</span>
          </div>
          
          <h3 className="text-xl font-semibold">Sign In to Daily English</h3>
          <p className="text-sm text-muted-foreground">
            Start your English learning journey with personalized daily topics
          </p>
        </div>

        <div className="flex flex-col space-y-4 bg-secondary/50 px-4 py-8 sm:px-16">
          <Button
